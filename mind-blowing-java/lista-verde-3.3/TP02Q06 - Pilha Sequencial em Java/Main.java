...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Pilha pilhaManipulavel = new Pilha();
        pilhaManipulavel.adicionarSeries(listaDadosSeries);
        pilhaManipulavel.quantidade--;
        for (int s = 0; s < quantidadeDeInstrucoes; s++) {
            ...
            switch (instrucao) {
            case "I":
                pilhaManipulavel.I(instrucoesEString.substring(2));
                break;
            case "R":
                pilhaManipulavel.R();
                break;
        ...
        for (int i = 0; i < pilhaManipulavel.quantidadeRemovidas; i++) {
            stdout.println("(R) " + pilhaManipulavel.removidas[i].getNome());
        }

        for (int j = pilhaManipulavel.quantidade - 1; j >= 0; j--) {
            pilhaManipulavel.series[j].printarDadosSerie();
        }
...
class Pilha {
    ...
    public void I(String nomeArquivoSerie) throws Exception {
        Serie novaSerie = new Serie();
