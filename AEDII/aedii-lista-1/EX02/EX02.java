...
public class EX02 {
    public static void main(String[] args) throws Exception {
        ...
        lista.InsereDepoisDe(teste1, lista.getPrimeiro());

        // Inserindo na ultima posição
        lista.InsereDepoisDe(teste2, lista.getUltimo());

        // Inserindo depois de um elemento que não existe
        Elemento naoExiste = new Elemento();
        naoExiste.setChave(1042);
        lista.InsereDepoisDe(teste3, naoExiste);
