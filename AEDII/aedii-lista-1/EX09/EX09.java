...
public class EX09 {
    public static void main(String[] args) throws Exception {
        ...
        Lista L2 = new Lista();
        for (int i = 0; i < 50; i++) {
            L1.InsereOrdenado(gerador.nextInt(5));
            L2.InsereOrdenado(gerador.nextInt(5));
        }
        ...
        System.out.println("Ultima ocorencia de 5: "+listaConcatenada.primeiraOcorrenciaDe(5));
        System.out.println("Ultima ocorencia de 3: "+listaConcatenada.primeiraOcorrenciaDe(3));
        System.out.println("Ultima ocorencia de 1: "+listaConcatenada.primeiraOcorrenciaDe(1));
        System.out.println("Ultima ocorencia de 2: "+listaConcatenada.primeiraOcorrenciaDe(2));
        System.out.println("Ultima ocorencia de 4: "+listaConcatenada.primeiraOcorrenciaDe(4));
    }
